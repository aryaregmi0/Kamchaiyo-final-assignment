...
const CompaniesPublic = () => {
    ...
    const renderContent = () => {
        ...
        if (isError) {
            return <p className="py-20 text-center text-destructive">Failed to load companies. Please try again later.</p>;
        }
        if (!companies || companies.length === 0) {
            return (
                <div className="py-20 text-center">
                    <h3 className="text-xl font-semibold">No Companies Available</h3>
                    <p className="mt-2 text-muted-foreground">Check back later to see a list of our partner companies.</p>
                </div>
            );
        }
        return (
    ...
    return (
        <div className="container py-10 mx-auto">
            <div className="mb-8 text-center">
                ...
                <p className="max-w-2xl mx-auto mt-2 text-muted-foreground">Discover great places to work and find jobs directly from top-tier companies verified by our platform.</p>
            </div>
            {renderContent()}
        </div>
    );
